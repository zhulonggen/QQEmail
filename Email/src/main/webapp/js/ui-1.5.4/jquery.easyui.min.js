...
$.ajax({type:opts.method,url:opts.href,headers:opts.headers,cache:false,data:_279,dataType:"html",success:function(data){
_27a(data);
},error:function(){
...
$.ajax({url:opts.url,headers:opts.headers,type:"post",xhr:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_878,dataType:"json",success:function(data){
_879(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_9e6,dataType:"json",success:function(data){
_9e7(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_aba,dataType:"json",success:function(data){
_abb(data);
},error:function(){
